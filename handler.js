  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝗡𝗮𝘀𝗮 𝗣𝗲 👑;;;\nFN:𝗡𝗮𝘀𝗮 𝗣𝗲 👑\nORG:𝗡𝗮𝘀𝗮 𝗣𝗲 👑\nTITLE:\nitem1.TEL;waid=51920011639:+51 920 011 639\nitem1.X-ABLabel:𝗡𝗮𝘀𝗮 𝗣𝗲 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:𝗡𝗮𝘀𝗮 𝗣𝗲 👑\nEND:VCARD`;
        await mconn.conn.sendMessage(nk.from, { contacts: { displayName: '𝗡𝗮𝘀𝗮 𝗣𝗲 👑', contacts: [{ vcard }] } }, { quoted: callmsg });
